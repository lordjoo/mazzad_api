...
Route::group([],function () {
    ...
    Route::get("recommendation/{product_id?}",[\App\Http\Controllers\Api\RecommendationController::class,"get"]);
    Route::get('/auction/bids/{auction_id}', [\App\Http\Controllers\Api\AuctionBidController::class, "getBids"]);
    Route::get('/auction/maxBid/{auction_id}', [\App\Http\Controllers\Api\AuctionBidController::class, "getMaxBid"]);
    Route::get("/auction/category/{id}",[\App\Http\Controllers\Api\AuctionController::class, "getAuctionByCategory"]);
...
Route::group(['middleware' => ['auth:api']], function () {
    ...
    Route::post("/feedBack/{message}", [\App\Http\Controllers\Api\FeedBack::class, "CreateFeedBack"]);
